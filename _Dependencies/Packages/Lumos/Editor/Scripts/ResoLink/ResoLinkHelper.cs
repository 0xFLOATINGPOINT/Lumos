...
namespace LightBakingResoLink {
    public class ResoLinkHelper {
        ...
        private static readonly HashSet<string> BlacklistedComponentsSlot = new HashSet<string> {
            ...
            "[FrooxEngine]FrooxEngine.LegacyGlowCircle",
            "[FrooxEngine]FrooxEngine.BoxGizmo",
            "[FrooxEngine]FrooxEngine.SlotGizmo",
            "[FrooxEngine]FrooxEngine.ConeGizmo",
            "[FrooxEngine]FrooxEngine.MeshGizmo",
            "[FrooxEngine]FrooxEngine.TextGizmo",
            "[FrooxEngine]FrooxEngine.ScaleGizmo",
            "[FrooxEngine]FrooxEngine.LightGizmo",
            "[FrooxEngine]FrooxEngine.SphereGizmo",
            "[FrooxEngine]FrooxEngine.VectorGizmo",
            "[FrooxEngine]FrooxEngine.BoxMeshGizmo",
            "[FrooxEngine]FrooxEngine.RotationGizmo",
            "[FrooxEngine]FrooxEngine.MaterialGizmo",
            "[FrooxEngine]FrooxEngine.SphereMeshGizmo",
            "[FrooxEngine]FrooxEngine.TranslationGizmo",
            "[FrooxEngine]FrooxEngine.BoxColliderGizmo",
            "[FrooxEngine]FrooxEngine.AxisRotationGizmo",
            "[FrooxEngine]FrooxEngine.MeshRendererGizmo",
            "[FrooxEngine]FrooxEngine.IcoSphereMeshGizmo",
            "[FrooxEngine]FrooxEngine.SphereColliderGizmo",
            "[FrooxEngine]FrooxEngine.AxisTranslationGizmo",
            "[FrooxEngine]FrooxEngine.PlaneTranslationGizmo",
            "[FrooxEngine]FrooxEngine.VolumeTranslationGizmo",
            "[FrooxEngine]FrooxEngine.EyeRotationDriverGizmo",
        };
